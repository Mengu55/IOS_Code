...
public class pickup_common extends BasePage {
	...
	private String switchToPickUp = "//XCUIElementTypeStaticText[@name=\"Switch To Pick-Up\"]";
	private String searchicon ="//XCUIElementTypeButton[@name=\"Search button\"]";
	...
	public void tapOnStartOrder() throws Exception{
		...
		public void switchtopickup () throws Exception {
			clickUsingXPath(switchToPickUp);
			Reporter.addStepLog("tapped on Switch to pickup button");
		
		}
		
		public void searchicon () throws Exception {
			clickUsingXPath(searchicon);
			Reporter.addStepLog("tapped on Search Icon");
